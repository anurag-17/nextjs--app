  ...
  return (
    <>
      <div className="flex justify-between items-center border border-[#f3f3f3] rounded-lg bg-white
        ...
        px-1 h-[25px] my-2
         ">
        <h2  className="2xl:text-2xl xl:text-[16px] lg:text-[14px] md:text-[14px] sm:text-[10px] text-[9px] font-semibold ">Edit Color </h2>
        <div className="mb-3 w-[40%]"></div>
      </div>
      <div>
        <form onSubmit={handleUpdateColor} className=" bg-white border  rounded-lg 2xl:p-2 xl:p-2  lg:p-1 md:p-2 p-1  mx-auto">
          <div>
