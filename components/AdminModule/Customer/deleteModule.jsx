...
const DeleteModuleCustomer = ({ customerID, closeModal, refreshData }) => {
  ...
  const handleDelete = (e) => {
    ...
    const options = {
      method: "DELETE",
      url: `https://e-commerce-backend-brown.vercel.app/api/auth/deleteaUser/${customerID}`,
      headers: {
...
export default DeleteModuleCustomer;
