...
const DeleteModuleV = ({ vendorID, closeModal, refreshData }) => {
  ...
  const handleDelete = (e) => {
    ...
    const options = {
      method: "DELETE",
      url: `https://e-commerce-backend-brown.vercel.app/api/vendor/deleteVendor/${vendorID}`,
      headers: {
